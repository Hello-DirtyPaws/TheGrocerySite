...
$sql = "Select Name, ID, Phone, Email from Users where Role='Employee'";
...
if($result != null && $result)
{
    ...
    while($row = $result->fetch_assoc())
    {
        ...
        echo "<tr>
                  ...
                  <td><a href='M_EditEmployee.php?id=$id'>Edit</a></td>
                  <td><a href='M_DeleteEmployee.php?id=$id'>Delete</a></td>
              </tr>";
        $i++;
    }
}
