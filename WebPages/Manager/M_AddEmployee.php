...
if($_SESSION["role"] != "Manager")
{
  ...
  if (isset($_POST['submit'])) 
  {
    ...
    else
    {
        ...
        $sql = "INSERT INTO Users (Email, Password, Name, Phone, Role) VALUES ('$email', '$pass', '$name', '$phone', 'Employee')";
        $result = $conn->query($sql);
        if($result != null && $result)
        {
            include("./M_ManagerEmployeePage.php");
            echo "<h3 align='center' style='color:green'>New Employee added.</h3>";
            exit;
        }
        else
        {
...
<html>
	...
	<body class="managerBody">
		...
		<h2 align="center">Add a new Employee Account</h2>
