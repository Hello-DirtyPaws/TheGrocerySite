<?php
session_start();
if($_SESSION["role"] != "Admin" || empty($_GET['id']) || $_GET['id']<2)
{
...
if (isset($_POST['submit'])) 
 {
    ...
    if($result != null && $result)
    {
        ...
        echo "<h3 align='center' style='color:green'>Manager(ID:$id_d) deleted successfully.</h3>";
        exit;
    }
    else
    {
        $id_d = $id;
        include('A_AdminManagerPage.php');
        echo "<h3 align='center' style='color:red'>Manager(ID:$id_d) does not exist. Please, try Again.</h3>";
        exit;
    }
  }
else 
{
    ...
    if($result != null && $result)
    {
        ...
        else
        {
            $id_d = $id; 
            include('A_AdminManagerPage.php');
            echo "<h3 align='center' style='color:red'>No Manager with id: $id_d exist. Please, try Again.</h3>";
            exit;
        }
    }
    else
...
<html>
    ...
    <?php include('AdminNavigationBar.php'); ?>
		...
		<form method='post' action=''>
		    ...
		    <table class='table'>
		        <tr>
		            <td>Manager ID: </td> <td><?php echo $id; ?></td>
		        </tr>
		        <tr>
